...
<div class="content">
    <div class="welcome-section">
        ...
        <p>Inilah ringkasan data Konveksi Cloteh hari ini.</p>
    </div>
    ...
    <div class="cards-grid">
        ...
        <div class="stat-card">{{ $barangMasuk }}
            <div class="card-header-flex">
                <h3>Barang Masuk</h3>
            ...
            <div class="desc"><span class="trend-up">↑ 12%</span> dari minggu lalu</div>
        </div>
