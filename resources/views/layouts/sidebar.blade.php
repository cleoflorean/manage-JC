    ...
    <div class="nav-scroller">
        <div class="sidebar-brand px-4 py-4">
            <a class="text-white fw-bold text-decoration-none fs-3" href="{{ url('dashboard') }}">
                <span class="text-primary">JC</span> <small class="fs-6 fw-light">Konveksi</small>
            </a>
        </div>

        <ul class="navbar-nav flex-column" id="sideNavbar">
            
            <li class="nav-item-label px-4 pb-2 text-uppercase fw-bold text-muted" style="font-size: 11px;">Main Menu</li>
